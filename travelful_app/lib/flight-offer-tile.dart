...
import 'flight-offer-detail.dart';

class FlightOfferTile extends StatelessWidget {
  FlightOffer offer;
  Map search;

  FlightOfferTile({Key key, this.offer, this.search})
      : super(key: key);
      ...
      child: new InkWell(
          onTap: () {
            Navigator.push(
                context,
                FadeRoute(
                    page: FlightOfferDetail(offer:offer,search:search)));
          },
