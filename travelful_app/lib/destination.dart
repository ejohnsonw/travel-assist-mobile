...
class DestinationInfo extends StatefulWidget {
  ...
  @override
  DestinationState createState() {
    state = new DestinationState(title: this.title, parent: this);
    return state;
  }
}

class DestinationState extends State<DestinationInfo> {
  ...
  DestinationState({this.title, this.parent});
  ...
  void initState() {
    ...
    citySelectedController.stream.listen(
          ...
          setState(() {
            ...
            selectedCity = (data as DestinationCitySelected).city;
            loadDestinationFeed(selectedCity, departing, returning);
          });
        },
        onDone: () {},
        onError: (error) {
  ...
  loadDestinationFeed(City selectedCity, DateTime departing, DateTime returning){
